							...
							<BR>
								<table border="2"
									...
									<tr
										...
										<td align="center"><font size="3">Need</font></td>
										<td align="center"><font size="3">Offer</font></td>
										<td align="center"><font size="3">DODO Code</font></td>               
                   						<td align="center"><font size="3">Action</font></td>    
									</tr>
									<%
										String islandname = null, need = null, code = null, offer = null;
										...
										rs1 = st1.executeQuery("select * from  tradeisland ");

										while(rs1.next()) {
											islandname = rs1.getString("islandname");
											need = rs1.getString("need");
											code = rs1.getString("code");
											offer = rs1.getString("offer");
											
											%>
											<tr style="color: #0000cc; background-color: wheat">
											<form name="ff" action="tradejoin.jsp" method="get"  onsubmit="return check()" >
	               							<input type="hidden" value="<%=islandname%>" name="islandname"/> 
											<td align="center"><%=islandname%></td>
											<td align="center"><%=need%></td>
											<td align="center"><%=offer%></td>
											<td align="center">"Deal to see"</td>
											<td align="center"><input type="submit" value="DEAL"></td>
										</tr>
